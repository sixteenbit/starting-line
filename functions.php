...
if ( ! function_exists( 'starting_line_setup' ) ) :
	...
	function starting_line_setup() {
		...
		*/
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'starting-line' ),
			)
		);
...
function starting_line_scripts() {
	...
	wp_enqueue_script( 'starting-line-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), wp_get_theme()->get( 'Version' ), true );
